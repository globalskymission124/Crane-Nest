...
const ko: Dictionary = {
  ...
  transfer: {
    ...
    terminalLabel: "터미널 선택",
    terminalRequiredBadge: "필수",
    terminalNote: "간사이 공항에는 터미널이 2개 있습니다. 이용하시는 항공사의 터미널을 선택해 주세요.",
    terminalOption: (n) => `제 ${n} 터미널`,
  ...
  wifi: {
    title: "게스트 WiFi 연결",
    description: "숙소 내에서 무료 WiFi를 이용하실 수 있습니다.",
    networkNameLabel: "네트워크 이름",
    passwordLabel: "비밀번호",
    copyPassword: "복사",
    copied: "복사됨",
    scanHint: "휴대폰 카메라로 QR 코드를 비추기만 하면 연결됩니다. 비밀번호 입력이 필요 없습니다.",
    sameDeviceHint: "이 기기로 연결하려면 아래 \"복사\"를 누른 뒤, Wi-Fi 설정에서 \"Crane Nest_Guest\"를 선택해 붙여넣으세요.",
    manualHint: "연결되지 않으면 위 정보를 직접 입력해 주세요.",
    androidConnect: "비밀번호 복사 후 WiFi 설정 열기",
    androidHint: "비밀번호를 복사했습니다. \"Crane Nest_Guest\"를 선택해 붙여넣으세요.",
  },
