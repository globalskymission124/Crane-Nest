...
export interface HostPagesDict {
  ...
  calendar: {
    ...
    gridTitle: string; selectDayHint: string; priceOverride: string; savePrice: string; clearOverride: string; blockDay: string; unblockDay: string; baseLabel: string;
  };
...
const ja: HostPagesDict = {
  ...
  calendar: { title: "カレンダー & Airbnb同期", subtitle: "AirbnbのiCal（.ics）と双方向で空室を同期します。", selectListing: "物件を選択", exportTitle: "① Airbnbへエクスポート", exportDesc: "このURLをAirbnbの「カレンダーを同期 → 別のサイトを接続」に貼り付けると、当サイトの予約がAirbnbに反映されます。", copy: "コピー", importTitle: "② Airbnbからインポート", importDesc: "Airbnbで発行したiCalエクスポートURL（.ics）を貼り付けて保存し、「今すぐ同期」で予約済み日を取り込みます。", saveUrl: "URLを保存", syncNow: "今すぐ同期", blocksTitle: "予約不可日（ブロック）", start: "開始", endExclusive: "終了（排他）", addBlock: "手動ブロック追加", noBlocks: "ブロックはありません。", srcManual: "手動", srcAirbnb: "Airbnb", srcBooking: "サイト予約", copied: "コピーしました。", urlSaved: "iCal URLを保存しました。", manualBlockNote: "オーナー手動ブロック", gridTitle: "料金・空室カレンダー", selectDayHint: "日付をクリックして料金設定・ブロックを編集できます。", priceOverride: "この日の料金（円）", savePrice: "料金を保存", clearOverride: "基準料金に戻す", blockDay: "この日をブロック", unblockDay: "ブロック解除", baseLabel: "基準" },
...
const en: HostPagesDict = {
  ...
  calendar: { title: "Calendar & Airbnb sync", subtitle: "Two-way availability sync with Airbnb iCal (.ics).", selectListing: "Select listing", exportTitle: "① Export to Airbnb", exportDesc: "Paste this URL into Airbnb's \"Sync calendars → Connect another website\" so your bookings here show on Airbnb.", copy: "Copy", importTitle: "② Import from Airbnb", importDesc: "Paste your Airbnb iCal export URL (.ics), save it, then \"Sync now\" to import booked dates.", saveUrl: "Save URL", syncNow: "Sync now", blocksTitle: "Blocked dates", start: "Start", endExclusive: "End (exclusive)", addBlock: "Add manual block", noBlocks: "No blocks.", srcManual: "Manual", srcAirbnb: "Airbnb", srcBooking: "Site booking", copied: "Copied.", urlSaved: "iCal URL saved.", manualBlockNote: "Host manual block", gridTitle: "Price & availability", selectDayHint: "Click a day to set its price or block it.", priceOverride: "Price for this day (JPY)", savePrice: "Save price", clearOverride: "Reset to base", blockDay: "Block this day", unblockDay: "Unblock", baseLabel: "Base" },
...
const tw: HostPagesDict = {
  ...
  calendar: { title: "日曆 & Airbnb同步", subtitle: "與Airbnb iCal（.ics）雙向同步空房。", selectListing: "選擇房源", exportTitle: "① 匯出至Airbnb", exportDesc: "將此URL貼到Airbnb的「同步日曆 → 連接其他網站」，本站的預訂即會顯示於Airbnb。", copy: "複製", importTitle: "② 從Airbnb匯入", importDesc: "貼上Airbnb的iCal匯出URL（.ics）並儲存，再點「立即同步」匯入已預訂日期。", saveUrl: "儲存URL", syncNow: "立即同步", blocksTitle: "不可預訂日（封鎖）", start: "開始", endExclusive: "結束（不含）", addBlock: "新增手動封鎖", noBlocks: "沒有封鎖。", srcManual: "手動", srcAirbnb: "Airbnb", srcBooking: "本站預訂", copied: "已複製。", urlSaved: "已儲存iCal URL。", manualBlockNote: "房東手動封鎖", gridTitle: "價格・空房日曆", selectDayHint: "點選日期以設定價格或封鎖。", priceOverride: "當日價格（日圓）", savePrice: "儲存價格", clearOverride: "恢復基準價", blockDay: "封鎖此日", unblockDay: "解除封鎖", baseLabel: "基準" },
...
const zh: HostPagesDict = {
  ...
  analytics: { title: "分析后台", scPayout: "预估收款（扣除手续费后）", scPayoutSubA: "总流通", scPayoutSubB: "手续费", scOcc: "未来30天平均入住率", scAdr: "平均房价 (ADR)", scRating: "平均评分", reviewsUnit: "条", chartRevenue: "各月营收（以入住月计）", chartBookings: "各月预订数", monthSuffix: "月", smartPricing: "智能定价建议", apply: "应用" },
  ...
  calendar: { title: "日历 & Airbnb同步", subtitle: "与Airbnb iCal（.ics）双向同步空房。", selectListing: "选择房源", exportTitle: "① 导出至Airbnb", exportDesc: "将此URL粘贴到Airbnb的「同步日历 → 连接其他网站」，本站的预订即会显示于Airbnb。", copy: "复制", importTitle: "② 从Airbnb导入", importDesc: "粘贴Airbnb的iCal导出URL（.ics）并保存，再点「立即同步」导入已预订日期。", saveUrl: "保存URL", syncNow: "立即同步", blocksTitle: "不可预订日（封锁）", start: "开始", endExclusive: "结束（不含）", addBlock: "新增手动封锁", noBlocks: "没有封锁。", srcManual: "手动", srcAirbnb: "Airbnb", srcBooking: "本站预订", copied: "已复制。", urlSaved: "已保存iCal URL。", manualBlockNote: "房东手动封锁", gridTitle: "价格・空房日历", selectDayHint: "点选日期以设定价格或封锁。", priceOverride: "当日价格（日元）", savePrice: "保存价格", clearOverride: "恢复基准价", blockDay: "封锁此日", unblockDay: "解除封锁", baseLabel: "基准" },
