...
const ja: Dictionary = {
  ...
  transfer: {
    ...
    terminalLabel: "ターミナルを選択",
    terminalRequiredBadge: "必須",
    terminalNote: "関西空港はターミナルが2つあります。ご利用の航空会社のターミナルを選択してください。",
    terminalOption: (n) => `ターミナル${n}`,
  ...
  wifi: {
    title: "ゲスト用WiFiに接続",
    description: "館内では無料WiFiをご利用いただけます。",
    networkNameLabel: "ネットワーク名",
    passwordLabel: "パスワード",
    copyPassword: "コピー",
    copied: "コピーしました",
    scanHint: "スマホのカメラでQRコードをかざすだけで接続できます。パスワードの入力は不要です。",
    sameDeviceHint: "この端末で接続する場合は、下の「コピー」を押してから、Wi-Fi設定で「Crane Nest_Guest」を選んで貼り付けてください。",
    manualHint: "うまくいかない場合は、上の情報を手動で入力してください。",
    androidConnect: "パスワードをコピーしてWiFi設定を開く",
    androidHint: "パスワードをコピーしました。「Crane Nest_Guest」を選んで貼り付けてください。",
  },
