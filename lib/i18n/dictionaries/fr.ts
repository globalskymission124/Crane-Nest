...
const fr: Dictionary = {
  ...
  transfer: {
    ...
    terminalLabel: "Choisissez votre terminal",
    terminalRequiredBadge: "Obligatoire",
    terminalNote: "L'aéroport du Kansai compte deux terminaux. Choisissez celui de votre compagnie aérienne.",
  ...
  wifi: {
    title: "Connectez-vous au WiFi invité",
    description: "Profitez du WiFi gratuit dans tout l'établissement.",
    networkNameLabel: "Nom du réseau",
    passwordLabel: "Mot de passe",
    copyPassword: "Copier",
    copied: "Copié",
    scanHint: "Pointez l'appareil photo de votre téléphone vers le QR code pour vous connecter, sans mot de passe.",
    sameDeviceHint: "Vous connectez ce téléphone ? Touchez « Copier » ci-dessous, ouvrez les réglages Wi-Fi, choisissez « Crane Nest_Guest » et collez-le.",
    manualHint: "Si cela ne fonctionne pas, saisissez les informations ci-dessus manuellement.",
    androidConnect: "Copier le mot de passe et ouvrir les réglages WiFi",
    androidHint: "Mot de passe copié. Sélectionnez « Crane Nest_Guest » et collez-le.",
  },
