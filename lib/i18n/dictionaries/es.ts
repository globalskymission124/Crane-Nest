...
const es: Dictionary = {
  ...
  transfer: {
    ...
    transferDateWarn: "⚠️ Selecciona la fecha de salida (check-out) como fecha del traslado. Revisa bien el mes y el día.",
    transferDateConfirm: (date) => `Confirmo que mi fecha de salida es ${date}`,
    roomLabel: "Selecciona tu habitación",
    roomLoading: "Cargando habitaciones...",
    destinationLabel: "Destino",
    destinationLoading: "Cargando destinos...",
    terminalLabel: "Selecciona tu terminal",
    terminalRequiredBadge: "Obligatorio",
    terminalNote: "El Aeropuerto de Kansai tiene dos terminales. Elige la que usa tu aerolínea.",
  ...
  wifi: {
    title: "Conéctate al WiFi para huéspedes",
    description: "Disfruta de WiFi gratis en todo el alojamiento.",
    networkNameLabel: "Nombre de la red",
    passwordLabel: "Contraseña",
    copyPassword: "Copiar",
    copied: "Copiado",
    scanHint: "Apunta la cámara de tu teléfono al código QR para conectarte, sin necesidad de contraseña.",
    sameDeviceHint: "¿Conectas en este móvil? Toca \"Copiar\" abajo, abre los ajustes de Wi-Fi, elige \"Crane Nest_Guest\" y pégala.",
    manualHint: "Si no funciona, introduce los datos anteriores manualmente.",
    androidConnect: "Copiar contraseña y abrir ajustes de WiFi",
    androidHint: "Contraseña copiada. Selecciona \"Crane Nest_Guest\" y pégala.",
  },
