...
const fr: Dictionary = {
  ...
  transfer: {
    ...
    preferredDepartureTimeRequiredBadge: "Obligatoire",
    preferredDepartureTimeNote: "Les transferts sont disponibles jusqu'à 10h00. Veuillez choisir votre heure de départ souhaitée.",
